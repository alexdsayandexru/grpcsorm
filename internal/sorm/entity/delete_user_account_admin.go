...
func (target *DeleteUserAccountAdmin) GetCorrelationId() string {
	return target.CorrelationId
}

func (target *DeleteUserAccountAdmin) GetName() string {
	return "DeleteUserAccountAdmin"
}

func (target *DeleteUserAccountAdmin) GetRules() ValidationRules {
