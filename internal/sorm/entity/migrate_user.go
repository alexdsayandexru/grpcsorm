...
type MigrateUser struct {
	...
	AbInfo        MigrateUserAbInfo `json:"ab_info"`
}

func (target *MigrateUser) GetCorrelationId() string {
	return target.CorrelationId
}

func (target *MigrateUser) GetName() string {
	return "MigrateUser"
}

func (target *MigrateUser) GetRules() ValidationRules {
	validationRules := map[string]func() (bool, error){
		...
		"datetime_updated": func() (bool, error) {
			return ValidateNotRequiredDatetime(target.AbInfo.DatetimeUpdated)
		},
